...
(function() {
  ...
  processResponse = function() {
    ...
    clientOrServerError = function() {
      var ref1;
      return (400 <= (ref1 = xhr.status) && ref1 < 600);
    };
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/persons/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1> Person Data Sheet </h1>\n\n<form id="upload-person" name="person">\n  <div class="field">\n    <label> Choose the person csv: </label>\n    <input type="file" name="person_data" id="person_data">\n  </div>\n\n  <div class="actions">\n    <input type="submit" value="Upload Data" />\n  </div>\n</form>\n\n<table id="persons-table">\n  <tr>\n    <th>First Name</th>\n    <th>Last Name</th>\n    <th>Email</th>\n    <th>Phone</th>\n    <th></th>\n    <th></th>\n  </tr>\n</table>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/persons/person"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (!has_error) { ; __p.push('\n\t<td>',  first_name ,'</td>\n\t<td>',  last_name ,'</td>\n\t<td>',  email ,'</td>\n\t<td>',  phone ,'</td>\n\t<td></td>\n\t<td></td>\n');  } ; __p.push(' \n\n');  if (has_error) { ; __p.push('\n\t<td><input type="text" name="first_name" value="',  first_name ,'" ></td>\n  <td><input type="text" name="last_name" value="',  last_name ,'" ></td>\n  <td><input type="text" name="email" value="',  email ,'" ></td>\n  <td><input type="text" name="phone" value="',  phone ,'" ></td>\n  <td><span class=\'error\'> ',  error_message ,' </span></td>\n  <td class=\'action\'>\n    <form class="error-person" name="person">\n      <input type="submit" value="Save" />\n    </form>\n  </td>  \n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() {
  var extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;

  TestProject.Models.Person = (function(superClass) {
  ...
  TestProject.Collections.PersonsCollection = (function(superClass) {
    extend(PersonsCollection, superClass);

    function PersonsCollection() {
      return PersonsCollection.__super__.constructor.apply(this, arguments);
    }

    PersonsCollection.prototype.model = TestProject.Models.Person;

    PersonsCollection.prototype.url = '/persons';
...
(function() {
  ...
  (base = TestProject.Views).Persons || (base.Persons = {});

  TestProject.Views.Persons.IndexView = (function(superClass) {
    var BULK_UPLOAD_URL;
    ...
    IndexView.prototype.template = JST["backbone/templates/persons/index"];
    ...
    IndexView.prototype.initialize = function() {
      ...
      return this.model = new this.collection.model();
    };

    IndexView.prototype.uploadFile = function(e) {
      var fileObj, reader, self;
      fileObj = e.target.files[0];
      reader = new FileReader;
      self = this;
      reader.onload = function(file) {
        return self.model.set('person_data', reader.result);
      };
      return reader.readAsText(fileObj);
    };

    IndexView.prototype.save = function(e) {
      var self;
      e.preventDefault();
      e.stopPropagation();
      self = this;
      return this.collection.create(this.model.toJSON(), {
        ...
        success: (function(_this) {
          return function(persons) {
            return persons.changed.data.forEach(function(person) {
              var model;
    ...
    IndexView.prototype.addOne = function(person) {
      var view;
      view = new TestProject.Views.Persons.PersonView({
        model: person
      });
...
(function() {
  ...
  TestProject.Views.Persons.PersonView = (function(superClass) {
    var URL;
    ...
    PersonView.prototype.template = JST["backbone/templates/persons/person"];
    ...
    PersonView.prototype.tagName = "tr";

    PersonView.prototype.onInput = function(e) {
      return this.model.set(e.target.name, e.target.value);
    };

    PersonView.prototype.reSave = function(e) {
      var self;
      e.preventDefault();
      e.stopPropagation();
      this.resetErrors();
    ...
    PersonView.prototype.resetErrors = function() {
      this.model.unset('has_error');
      this.model.unset('error_message');
      return this.model.unset('person_data');
    };
...
(function() {
  ...
  TestProject.Routers.PersonsRouter = (function(superClass) {
    extend(PersonsRouter, superClass);

    function PersonsRouter() {
      return PersonsRouter.__super__.constructor.apply(this, arguments);
    }

    PersonsRouter.prototype.initialize = function(options) {
      this.persons = new TestProject.Collections.PersonsCollection();
      return this.persons.reset(options.persons);
    };

    PersonsRouter.prototype.routes = {
      "index": "index",
      ".*": "index"
    };

    PersonsRouter.prototype.index = function() {
      this.view = new TestProject.Views.Persons.IndexView({
        collection: this.persons
      });
      return $("#persons").html(this.view.render().el);
    };
